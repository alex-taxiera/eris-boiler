...
class Orator {
        ...
        try {
          ...
          switch (error.message) {
            default:
              ...
              responseContent = 'This command requires the "Manage Webhooks" permission!' 
              break
          }
        }
      }

      newMessage = await this._replyOrDirect(response, bot, msg, responseContent)
  ...
  _replyOrDirect (response, bot, msg, content) {
    return response.dm
