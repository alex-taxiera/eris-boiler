...
class DatabaseManager {
  ...
  newObject (type, data, isNew = true) {
    return new this._DataObject(this, type, data, { isNew })
  }
   ...
   */
  newQuery (type) {
    return new this._DataQuery(this, type)
  }
   ...
   * @return {Promise<Object>}      The new DatabaseObject (should not need to be saved).
   */
  async add (type, data) {
