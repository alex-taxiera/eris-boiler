...
type AllCommandOptionTypes =
  (typeof Constants.ApplicationCommandOptionTypes)[keyof typeof Constants.ApplicationCommandOptionTypes]
...
type AutocompleteCommandOptionTypes = Extract<
  ApplicationCommandOptionTypes,
  3 | 4 | 10
>

export type AutocompleteAction<T extends AutocompleteCommandOptionTypes> =
...
> = CoreCommandActionWithOptions<
  CommandInteraction,
  ConvertOptionsToArgs<O, InteractionDataOptionsWithValue>,
  Hephaestus
>

export type UserCommand = UserApplicationCommandStructure & {
  action: CommandAction
}

export type MessageCommand = MessageApplicationCommandStructure & {
  action: CommandAction
}
