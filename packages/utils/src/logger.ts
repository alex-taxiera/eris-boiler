 ...
 */
export function error(...content: Content): void {
 ...
 * @param content The stuff to log, can be anything, use like console.log
 */
export function info(...content: Content): void {
 ...
 * @param content The stuff to log, can be anything, use like console.log
 */
export function success(...content: Content): void {
 ...
 * @param content The stuff to log, can be anything, use like console.log
 */
export function warn(...content: Content): void {
