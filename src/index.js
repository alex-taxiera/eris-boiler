...
async function start () {
  ...
  promises.push(readdir(path.join(__dirname, './loaders/')).then((loaders) => {
  ...
  /* load commands */
  promises.push(readdir(path.join(__dirname, './commands/')).then((commands) => {
  ...
  promises.push(readdir(path.join(__dirname, './events/')).then((events) => {
  ...
  /* load permissions */
  promises.push(readdir(path.join(__dirname, './permissions/')).then((permissions) => {
  ...
  /* load settings */
  promises.push(readdir(path.join(__dirname, './settings/')).then((settings) => {
  ...
  /* load toggles */
  promises.push(readdir(path.join(__dirname, './toggles/')).then((toggles) => {
